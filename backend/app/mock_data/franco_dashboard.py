FRANCO_DASHBOARD = {
    ...
    "alerts": [
        ...
        },
        {
            ...
            "message": "Te sobraron $700.000 este mes. Moviéndolos a un plazo fijo de 30 días generarías ~$57.500 de rendimiento antes de que el capital quede inactivo en cuenta corriente.",
            "action": "Simular rendimiento",
        },
        {
            "alert_id": "franco_alert_003",
            "type": "fixed_term_maturity",
            "severity": "medium",
            "title": "Plazo fijo vence en 5 días",
            "message": "Tu plazo fijo de $500.000 vence el 11 de junio. Decidí si renovarlo automáticamente o reasignar el capital antes de que quede sin rendir en caja de ahorro.",
            "action": "Decidir renovación",
        },
        {
            "alert_id": "franco_alert_004",
            "type": "savings_goal_reached",
            "severity": "opportunity",
            "title": "En camino hacia el objetivo de retiro",
            "message": "Al ritmo actual acumulás $8.400.000 en los próximos 12 meses. Estás exactamente en línea con tu objetivo de retiro proyectado. Mantené el rumbo.",
